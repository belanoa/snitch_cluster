...
module snitch_hive import snitch_icache_pkg::*; #(
  ...
  if (SharedMuldiv) begin
    ...
    assign acc_req_sfu_ready_q = '0;
    assign acc_resp_sfu.data   = '0;
    assign acc_resp_sfu.id     = '0;
    assign acc_resp_sfu.error  = '0;
    assign acc_resp_sfu_valid  = '0;
  end
